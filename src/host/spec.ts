...
const promptIdSchema = z.string().min(1).transform(value => value as TaskBoardPromptId)
const activityIdSchema = z.string().min(1).transform(value => value as TaskBoardActivityId)
...
}) as unknown as z.ZodType<TaskBoardRoundPrompt>
...
}) as unknown as z.ZodType<TaskBoardRound>
...
]) as z.ZodType<TaskBoardActivity>
...
}) as unknown as z.ZodType<TaskBoardTask>
