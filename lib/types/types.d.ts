...
export type TaskBoardEditableField = 'title' | 'description' | 'acceptanceCriteria' | 'workspaceId' | 'cwd' | 'agentPreset' | 'attachments';
...
export type TaskBoardFailureResult = TaskBoardTaskNotFound | TaskBoardRevisionConflict | TaskBoardInvalidTransition | TaskBoardRoundAlreadyActive | TaskBoardSessionOwnedByAnotherTask | TaskBoardSessionUnavailable | TaskBoardFreshSessionRequired | TaskBoardPromptRejected | TaskBoardInvalidRequest | TaskBoardAttachmentFailure;
